import math
# feet = int(input ("what is your height in feet?")) #6
# inch = int(input ("what is your heigt in inch?"))#6

# fheight = feet * 30
# iheight = inch * 2.54
# theight = fheight + iheight

# fheight = feet * 30
# iheight = inch * 2.54 
# theight = fheight + iheight
# print (f"your height is {fheight} and {iheight} inches which is {theight} cm")
...
# total_seconds = 125
# minutes = # Part 1: Learning Exercises
...
# studentnums = 38
# groupsof4 = studentnums // 4
# leftover = studentnums % 4
# print(f"{groupsof4} groups and {leftover} people leftover")
...
print(f"The fuel cost is ${math.ceil(fuelcost)}")
